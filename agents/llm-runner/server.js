...
const PORT = 80;
const LLM_URL = 'https://kgjh5inrp412t4-8000.proxy.runpod.net/v1/chat/completions';
...
async function handleRequest(req, res) {
  ...
  try {
    ...
    const handlers = createHandlers(addStep, response);
    ...
    console.log(`[${requestId}] Response: ${encoded.slice(0, 100)}...`);
