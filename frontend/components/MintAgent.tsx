...
export function MintAgent() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 space-y-4 border border-gray-200">
      <h2 className="text-2xl font-bold text-gray-900">Mint New Agent</h2>
      
      <form onSubmit={handleMint} className="space-y-4">
        <div>
          <label htmlFor="recipient" className="block text-sm font-semibold text-gray-900 mb-2">
        ...
        <div>
          <label htmlFor="uri" className="block text-sm font-semibold text-gray-900 mb-2">
            Metadata URI
          </label>
          <input
            id="uri"
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white py-2.5 px-4 rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-semibold transition-colors"
        >
